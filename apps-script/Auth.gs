 ...
 *   admin_master — tudo: cadastrar RTI, ver termo, gerenciar QUALQUER usuário
 *                  (inclusive outros admins), ver o LOG de auditoria.
 *   admin        — cadastrar RTI, ver termo, criar/desativar apenas
 *                  user1/user2 (nunca admin ou admin_master).
 *   user1        — apenas cadastrar RTI.
 *   user2        — apenas navegação básica do site (sem RTI, sem termo).
 */
